...
<div class="row"><button type="button" class="btn btn-primary">Apple pay (fast checkout)</button></div>
<div class="row"><button type="button" class="btn btn-primary">Google pay (fast checkout)</button></div>
<div class="row"><button type="button" class="btn btn-primary">Paga con carta</button></div>
