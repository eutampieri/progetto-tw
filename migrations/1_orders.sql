CREATE TABLE `order` (id INTEGER PRIMARY KEY, cart_id INTEGER NOT NULL, user_id INTEGER NOT NULL, tracking_number TEXT, express_courier_id INTEGER, payment_id TEXT NOT NULL);
